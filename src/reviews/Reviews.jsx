        ...
        <ul className="reviews__list">
          <li className="reviews__item">
            ...
            <div className="reviews__item-frame">
              <img src={require("../img/reviews/reviews_item_frame.png")} />
            </div>
            <img className="reviews__item-photo" src={require("../img/reviews/reviews_item_photo_1.jpg")} />
          </li>
          <li className="reviews__item">
            ...
            <img className="reviews__item-photo" src={require("../img/reviews/reviews_item_photo_2.jpg")} />
          </li>
          <li className="reviews__item">
